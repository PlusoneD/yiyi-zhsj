...
<body class="app sidebar-mini">
    ...
    <ul class="app-menu">
      ...
      <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i
        ...
        <ul class="treeview-menu">
          ...
          <li><a class="treeview-item active" href="Patient_Drip.html"><i class="icon fa fa-circle-o"></i>点滴提示</a></li>
        </ul>
      </li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-th-list"></i> 查看点滴</h1>
      </div>
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">点滴提示</li>
        <li class="breadcrumb-item active"><a href="#">查看点滴</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#tbody").append(template("DripP-script",{data:data}));
