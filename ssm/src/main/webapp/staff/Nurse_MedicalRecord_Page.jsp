        ...
        <div class="col-md-3">
          <div class="tile p-0">
            <ul class="nav flex-column nav-tabs user-tabs">
              ...
              <li class="nav-item"><a class="nav-link" href="#user-timeline" data-toggle="tab" onclick="alertNur()">新建病历</a></li>
            </ul>
          </div>
        </div>
      <div class="col-md-9">
            ...
            <div class="timeline-post">
              ...
              <div class="tile user-settings">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                    <label>医生编号</label>
                    <input class="form-control" name="Did" type="text">
                    </div>
                    <div class="col-md-12 mb-4">
                    <label>患者编号</label>
                    <input class="form-control" id="Pid" name="Pid" type="text" value="<%out.print(patientId);%>"> 
                    </div>
                    <div class="col-md-12 mb-4">
                    <label>主诉</label>
                    ...
                    <div class="col-md-12 mb-4">
                    <label>处方说明</label>
                    <textarea class="form-control"  type="5"></textarea>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-12 mb-4">
                    <label>建议</label>
