...
public class MedRecord {
    ...
    private String M_PrescriptionInstructions;
    
    public MedRecord(String medRecord_id,String doctor_id,String patient_id,String m_Time,String m_State,String m_Complaint,String m_InspectResult,String m_Diagnosis,String m_Advice,String m_PrescriptionInstructions) {
    ...
    public String getPrescriptionInstructions() {
        return M_PrescriptionInstructions;
    }
 
    public void setPrescriptionInstructions(String PrescriptionInstructions) {
        this.M_PrescriptionInstructions = PrescriptionInstructions == null ? null : PrescriptionInstructions.trim();
    }
}