...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
        ...
        <div>
          <p class="app-sidebar__user-name">职工名</p>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
          ...
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="Doctor_MedicalRecord_History.html"><i class="icon fa fa-circle-o"></i>
                历史记录</a></li>
            <li><a class="treeview-item" href="Nurse_MedicalRecord_Search.html"><i class="icon fa fa-circle-o"></i>
                病患查找</a></li>
          </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
    ...
    <main class="app-content">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row" action="medrecordNurPage" method="post">
                      <div class="form-group col-md-3">
                        <label class="control-label">病患姓名</label>
                        <input class="form-control" type="text" name="name" placeholder="输入病患姓名">
                      </div>
                      <div class="form-group col-md-3">
                        <label class="control-label">病患医保卡号</label>
                        <input class="form-control" type="text" name="id" id="id" placeholder="按标准格式输入医保卡号">
                      </div>
                      <div class="form-group col-md-4 align-self-end">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>查找</button>
                      </div>
                    </form>
                </div>
            </div>
