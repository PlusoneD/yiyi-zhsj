  ...
  <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
   <aside class="app-sidebar">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> 药品数据库修改</h1>
          
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">数据库管理</li>
          <li class="breadcrumb-item"><a href="#">药品数据库</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">新增药品</h3>
            <div class="tile-body">
             <form action="insertDrug" method="post">
            
                <div class="form-group">
                  <label class="control-label">名称</label>
                  <input class="form-control" type="text" name="cname" placeholder="填写药品全名">
                </div>
                <div class="form-group">
                  <label class="control-label">通用名</label>
                  <input class="form-control" type="text" name="commonname" placeholder="填写药品全名">
                </div>
                <div class="form-group">
                  <label class="control-label">英文名</label>
                  <input class="form-control" type="text" name="engname" placeholder="填写药品全名">
                </div>
                <div class="form-group">
                  <label class="control-label">展示名</label>
                  <input class="form-control" type="text" name="showname" placeholder="填写药品全名">
                </div>
                <div class="form-group">
                    <label class="control-label">主要成分</label>
                    <textarea class="form-control" type="2" name="component" placeholder="填写药品主要成分"></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">功能主治</label>
                  <textarea class="form-control" type="3" name="indication" placeholder="填写药品主治病症"></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">使用方法</label>
                  <textarea class="form-control" rows="5" name="dosage" placeholder="填写药品用量用法"></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">用药禁忌</label>
                  <textarea class="form-control" rows="5" name="contraindications" placeholder="填写药品禁忌"></textarea>
                </div>
                <div class="form-group">
                  <label class="control-label">预防措施</label>
                  <textarea class="form-control" rows="5" name="precaution"></textarea>
                </div>
                 <div class="form-group">
                  <label class="control-label">副作用</label>
                  <textarea class="form-control" rows="5" name="adversereaction"></textarea>
                </div>
                 <div class="form-group">
                  <label class="control-label">药物相互作用</label>
                  <textarea class="form-control" rows="5" name="druginteraction"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label">形态</label>
                    <textarea class="form-control" rows="2" name="type"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label">包装</label>
                    <textarea class="form-control" rows="2" name="pack"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label">内含药物名</label>
                    <textarea class="form-control" rows="2" name="inncomponentname"></textarea>
                </div>
              
                <div class="form-group">
                  <div class="form-check">
                    <label class="form-check-label">
                      <input class="form-check-input" name="confirm" type="checkbox">确认按药品数据库标准要求填写完毕
                    </label>
                  </div>
                </div>
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">修改药品</h3>
            <div class="tile-body">
                            <form action="updateDrug" method="post">
                <div class="form-group">
                    <label class="control-label">编号</label>
                    <input class="form-control" name="id" type="text" placeholder="填写药品编号">
                </div>
                <div class="form-group">
                  <label class="control-label">名称</label>
                  <input class="form-control" type="text" name="cname" placeholder="填写药品全名">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">删除药品</h3>
            <div class="tile-body">
              <form class="row" action="/delDrug" method="post">
                <div class="form-group col-md-3">
                  <label class="control-label">编号</label>
                  <input class="form-control" name="id" type="text" placeholder="填写正确编号">
                </div>
                <div class="form-group col-md-4 align-self-end">
                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>删除</button>
                </div>
              </form>
            </div>
          </div>
