  ...
  <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
   <aside class="app-sidebar">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> 病症数据库修改</h1>
      ...
      <div class="row" >
            ...
            <div class="tile-body">
              <form action="insertSym" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="id" name="id" type="text" placeholder="填写病症编号">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="form-check">
                    <label class="form-check-label">
                      <input class="form-check-input" id="symConfirm" type="checkbox">确认按病症数据库标准要求填写完毕
                    </label>
                  </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="tile">
                <h3 class="tile-title">修改病症</h3>
                <div class="tile-body">
                  <form action="updateSym" method="post">
                    <div class="form-group">
                        <label class="control-label">编号</label>
                        <input class="form-control" name="id" type="text" placeholder="填写病症编号">
                    </div>
                    <div class="form-group">
                        <label class="control-label">人体部位</label>
                        <textarea class="form-control" name="bodypart" type="2" placeholder="填写人体部位"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">详细描述</label>
                        <textarea class="form-control" name="description" type="5" placeholder="填写详细描述"></textarea>
                        </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">删除病症</h3>
            <div class="tile-body">
              <form class="row" action="/delSym" method="post">
