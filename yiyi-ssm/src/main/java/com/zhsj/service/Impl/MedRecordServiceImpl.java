...
public class MedRecordServiceImpl implements MedRecordService {
    ...
    @Override
    public void saveMedRecord(String medRecord_id,String doctor_id,String patient_id,String m_Time,String m_State,String m_Complaint,String m_InspectResult,String m_Diagnosis,String m_Advice) {
		medrecordDao.insert(medRecord_id,doctor_id,patient_id,m_Time,m_State,m_Complaint,m_InspectResult,m_Diagnosis,m_Advice);
	}
    @Override
