...
//    int insert(MedRecord medrecord);
	...
	void insert(@Param("medRecord_id")String medRecord_id, @Param("doctor_id")String doctor_id, @Param("patient_id")String patient_id, @Param("m_Time")String m_Time, @Param("m_State")String m_State,
			@Param("m_Complaint")String m_Complaint, @Param("m_InspectResult")String m_InspectResult, @Param("m_Diagnosis")String m_Diagnosis, @Param("m_Advice")String m_Advice);
